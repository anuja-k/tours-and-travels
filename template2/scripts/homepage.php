...
<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
 ...
 //dateFormat: "dd/mm/y",
                //changeMonth: true,
                //changeYear: true,
				//minDate: +1, maxDate: "+4M + 0D",
 //onClose: function(dateText, inst) {
   //             var validDate = $.datepicker.formatDate( "dd/mm/y",                                  $('#datepicker1').datepicker('getDate'));
     //       $('#datepicker1').datepicker('setDate', validDate); },
 //defaultDate: null,
        });
    });*/
		 $( function() {
    ...
    <div class="travel">
	  <nav class="navbar navbar-default">
	   <div class="container-fluid">
		...
		<form action="flightOneResults.php"  method="POST" enctype="multipart/form-data">
		<ul>
		<li class="sell ui-widget"> <label for="Airport">From</label>
		                 <input id="Airport" name="Airport" required>
		...
		<li class="seld">    <label for="datepicker">Departure</label>
		                 	 <input placeholder="Departure" type="text" id="datepicker" name="dat" required>
                            </li>
		<!--<li class="seld">    <label for="datepicker1">Arrival</label>
                 			<input type="text" placeholder="Arrival" id="datepicker1">
		...
		<br>
		 <input class="btn custom-btn" type="submit" value="SEARCH FLIGHTS" name="SUBMIT"></input>
	</div>
	</div>
	</center>
 </div>
