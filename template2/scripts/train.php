...
<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
 ...
 onClose: function(dateText, inst) {
                var validDate = $.datepicker.formatDate( "y/mm/dd/D",                                  $('#datepicker').datepicker('getDate'));
	  ...
	  <nav class="navbar navbar-default">
	   <div class="container-fluid">
	       <ul class="nav navbar-nav">
				 ...
				 <li class="active" ><a href="train.php"><i class="ion-android-train"></i> TRAIN</a></li>
			</ul>
        </div>
        </nav>	 
		<div class="book">
		<h2 class="he"> Book Online Train Tickets  </h2>
		<br>
		<br>
		<div class="a">
		<!--<ul >
		...
		<ul>
		<li class="sell ui-widget" > <label for="Source">From</label>
		...
		<li class="seld">    <label for="datepicker">Departure</label>
		                 	 <input placeholder="Departure" type="text" name="datepicker" id="datepicker" required>
                            </li>
