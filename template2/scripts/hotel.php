	  ...
	  <nav class="navbar navbar-default">
	   <div class="container-fluid">
	       <ul class="nav navbar-nav">
				 ...
				 <li class="active"><a href="hotel.php"><i class="ion-ios-home"></i> HOTEL</a></li>
		...
		<ul>
		<li class="sell"> <label for="from">City,Hotel</label>
		                 <select id="from">
		...
		<!--<li class="sell"> <label for="to">To</label>
		                 <select id="to">
							<option>America</option>
							<option>Bangladesh</option>
							<option>Canada</option>
		...
		<ul>
		<li class="seld">    <label for="datepicker">Check in</label>
		                 	 <input placeholder="Check in" type="text" id="datepicker">
                            </li>
		<li class="seld">    <label for="datepicker1">Check out</label>
                 			<input type="text" placeholder="Check out" id="datepicker1">
