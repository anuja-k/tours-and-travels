    ...
    <div class="travel">
	  <nav class="navbar navbar-default">
	   <div class="container-fluid">
		...
		<div class="a">
		<ul >
		<li class="sel"><input type="radio" id="one-way"  onclick="location.href='homepage.php'" name="selector"> <label for="one-way">One Way</label></li>
	    <li class="sel"><input type="radio" id="round-trip" checked name="selector"> <label for="round-trip">Round Trip</label>
		                </li>
        </ul>
		
		<ul>
		<li class="sell"> <label for="from">From</label>
		                 <select id="from">
		...
		<li class="seld">    <label for="datepicker">Departure</label>
		                 	 <input placeholder="Departure" type="text" id="datepicker">
                            </li>
