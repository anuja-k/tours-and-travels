...
$bsid=$_SESSION['bsid'];
	...
	//echo $date;
	//echo $booking_date;
	$updatequery="insert into Transactions values('','$booking_date','$date','$bsid','$charge','$i','$emailid','booked')";
...
$sql3="SELECT * from Buses";
	...
	$sql4="update Buses set Availability='$availability' where BusID='$busid'";
