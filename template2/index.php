	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<!-- Brand and toggle get grouped for better mobile display -->
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php" title="HOME"><i class="ion-paper-airplane"></i> Tours <span>& Travels</span></a>
			</div> <!-- /.navbar-header -->
	    ...
	    <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="scripts/loginpage.html">Login</a></li>
					<li><a href="scripts/signuppage.html">Sign up</a></li>
		            ...
		            <li class="slider-item" style="background-image: url('assets/images/bus1.jpg')">
		                <div class="intro container">
		                    <div class="inner-intro">
		                        ...
		                        <button class="btn custom-btn" onclick="location.href='scripts/loginpage.html'">
		                            book now
		                        </button>
		                    </div>
		                </div>
